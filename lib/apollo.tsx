...
// Extend the NextPageContext to allow for the client and state to be cached
 ...
 */
export const initOnContext = (ctx: NextPageContextWithApollo) => {
  // Initialize ApolloClient if not already done
  const apolloClient =
    ctx.apolloClient || initApolloClient(ctx.apolloState || {}, ctx);
